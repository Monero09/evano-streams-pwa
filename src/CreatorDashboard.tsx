...
import { uploadVideo, getMyVideos, type Video } from './lib/api';
        ...
        <div className="dashboard-container" style={{ padding: 20, maxWidth: 800, margin: '0 auto', color: 'white' }}>
            ...
            <div className="stats" style={{ display: 'flex', gap: 20, marginBottom: 40 }}>
                <div style={{ background: '#1A1F2E', padding: 20, borderRadius: 10, flex: 1 }}>
                    <h3>Total Views</h3>
                    <p style={{ fontSize: 24, fontWeight: 'bold', color: '#FF6A00' }}>{totalViews.toLocaleString()}</p>
                </div>
                <div style={{ background: '#1A1F2E', padding: 20, borderRadius: 10, flex: 1 }}>
                    <h3>Total Videos</h3>
                    <p style={{ fontSize: 24, fontWeight: 'bold', color: '#FF6A00' }}>{myVideos.length}</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 15 }}>
                ...
                <button
                    ...
                    style={{
                        padding: 14,
                        background: uploading ? '#555' : '#FF6A00',
                        color: 'white',
                        border: 'none',
                        borderRadius: 8,
                        fontSize: 16,

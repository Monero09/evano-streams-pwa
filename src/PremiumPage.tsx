        ...
        <div className="auth-container">
            <div className="auth-box">
                ...
                <div style={{ margin: '30px 0' }}>
                    ...
                    <div style={{ marginTop: 40, background: 'rgba(214, 0, 116, 0.05)', borderRadius: 12, padding: 20, border: '1px solid rgba(214, 0, 116, 0.2)' }}>
                        <h3 style={{ fontSize: 16, marginBottom: 20, color: '#D60074', textAlign: 'center' }}>
                            FREE vs PREMIUM
                        </h3>
                        <div style={{ display: 'grid', gap: 12 }}>
                            {[
                                { feature: 'Watch Videos', free: '✓', premium: '✓' },
                                { feature: 'Video Quality', free: '720p', premium: '4K' },
                                { feature: 'Ads', free: 'Yes', premium: 'No' },
                                { feature: 'Downloads', free: '✗', premium: '✓' },
                                { feature: 'Simultaneous Streams', free: '1 Device', premium: '4 Devices' },
                                { feature: 'Priority Support', free: '✗', premium: '✓' },
                                { feature: 'Ad-Free Browsing', free: '✗', premium: '✓' },
                                ...
                                <div key={row.feature} style={{
                                    ...
                                    <div style={{ fontSize: 13, fontWeight: 500, color: '#B0B8C1' }}>{row.feature}</div>
                                    <div style={{ fontSize: 13, color: '#888', textAlign: 'center' }}>{row.free}</div>
                                    <div style={{ fontSize: 13, color: '#52c41a', fontWeight: 600, textAlign: 'center' }}>{row.premium}</div>
                                </div>
                            ))}
                        </div>
                    </div>
